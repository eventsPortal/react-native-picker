...
RCT_EXPORT_METHOD(_init:(NSDictionary *)indic){
    ...
    NSString *leftButtonLeftOffset=indic[@"leftButtonLeftOffset"];
    NSString *rightButtonRightOffset=indic[@"rightButtonRightOffset"];
